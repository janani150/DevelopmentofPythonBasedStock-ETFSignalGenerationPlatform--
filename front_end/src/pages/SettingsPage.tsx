    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="glass-card space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input defaultValue="john@example.com" className="bg-secondary border-border text-foreground" />
          </div>
        </div>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="glass-card space-y-4">
        ...
        <div>
          ...
          <Input type="password" defaultValue="sk-xxxxxxxxxxxxx" className="bg-secondary border-border text-foreground font-mono" />
        </div>
        <div>
