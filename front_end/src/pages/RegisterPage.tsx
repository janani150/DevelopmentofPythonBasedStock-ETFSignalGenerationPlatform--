        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <Input placeholder="John Doe" className="pl-9 bg-secondary border-border text-foreground" />
            </div>
          </div>
          <div>
          ...
          <Link to="/dashboard">
            <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 h-11">Create Account</Button>
          </Link>
        </div>
